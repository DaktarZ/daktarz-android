...
public class GetCurrentLocationActivity extends Activity {

    SharedPreferences prefs;
 //   private Button GetCurrentLocation;

    @BindView(R.id.btnCurrent_loc)
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(GetCurrentLocationActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(GetCurrentLocationActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
